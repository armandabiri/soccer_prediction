...
def confident_bets_section(forecast: MatchForecast) -> str:
    ...
    return (
        ...
        "relative confidence. This is a model-probability plan (not venue quotes); it normalizes "

        "categories so corners, scorers, scores, and result markets are comparable on one $100 roll.</p>"
